...
//        }
    ...
    void uploadPicture() {
//        //文件绝对路径
//        File folder = new File("/Users/leopold-lee/Documents/CS/OOAD/Hotel-Management-System/hotel-thirdparty/src/test/java/sustech/hotel/thirdparty/img");
//        File[] files = folder.listFiles();
//        //下面都不用改动
//
//        //url: https://ooad-1312953997.cos.ap-guangzhou.myqcloud.com/img/ + filename
//        for (File file : files) {
