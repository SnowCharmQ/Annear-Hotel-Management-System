<template>
  <div class="page-main">
      ...
      <div class="top-link">
        ...
        <el-popover
          ...
          <div class="flex-row" slot="reference">
            <el-link>US Dollars<i class="el-icon-arrow-down"></i></el-link>
          </div>
        </el-popover>
    ...
    <el-row class="card-search" :gutter="20" style="width:1250px;margin:20px auto;">
      <el-col :span="18" style="background:#fff; padding: 0 0;">
              ...
              <div style="padding:15px 0;" class="add-form">
                <el-form ref="form" label-width="80px">
                  ...
                  <el-form-item label="Children">
                    <el-input-number v-model="count2" :min="0"></el-input-number>
                  </el-form-item>
                  <div style="line-height:50px;border-top:1px solid #ddd;text-align:right;">
                    <el-button type="info">Apply</el-button>
                  </div>
                </el-form>
              </div>
            </div>
          ...
          <el-col :span="24" v-for="item in imgList" :key="item.name" class="room-list">
            ...
            <div class="room-right">
              ...
              <div class="flex-row2" style="font-size:13px;color: #666;">
                <div>Rates are on room only basis</div>
                <div>Per Night</div>
              </div>
              <div style="text-align:right;font-size:12px;margin-top: -10px;">Excluding Taxes & Fees</div>
              <div style="text-align:right;">
                <el-button type="info" style="background:black;color:#fff;">Book Now</el-button>
              </div>
              <el-divider></el-divider>
              <div class="flex-row2" style="margin-top:-10px;">
                <div>Breakfast in Manhattan</div>
                <div style="font-weight:600;">A${{ item.price }}</div>
              </div>
              <div class="flex-row2" style="font-size:13px;color: #666;">
              ...
              <div style="text-align:right;font-size:12px;margin-top: -10px;">Excluding Taxes & Fees</div>
              <div class="">Daily American breakfast in Arva or via in-room dining up to two people</div>
              <div style="text-align:right;">
                <el-button type="info" style="background:black;color:#fff;">Book Now</el-button>
              </div>
            </div>
